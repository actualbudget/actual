...
export type AdressType = "Business" | "Correspondence" |
...
export type BalanceStatus = "CLAV" | "CLBD" | "FWAV" |
    "INFO" | "ITAV" | "ITBD" | "OPAV" | "OPBD" | "OTHR" |
    "PRCD" | "VALU" | "XPCD";

export type CashAccountType = "CACC" | "CARD" | "CASH" |
    "LOAN" | "OTHR" | "SVGS";
...
export type SchemeName = "ARNU" | "BANK" | "BBAN" | "BGNR" |
    "CCPT" | "CHID" | "COID" | "CPAN" | "CUSI" | "CUST" |
    "DRLC" | "DUNS" | "EMPL" | "GS1G" | "IBAN" | "MIBN" |
    "NIDN" | "OAUT" | "OTHC" | "OTHI" | "PGNR" | "SOSE" |
    "SREN" | "SRET" | "TXID";
...
export type SessionStatus = "AUTHORIZED" | "CANCELLED" |
    "CLOSED" | "EXPIRED" | "INVALID" | "PENDING_AUTHORIZATION" |
    "RETURNED_FROM_BANK" | "REVOKED";
