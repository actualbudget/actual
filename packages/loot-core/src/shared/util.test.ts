...
describe('utility functions', () => {
  test('looseParseAmount works with basic numbers', () => {
    ...
    expect(looselyParseAmount('3', 2)).toBe(3);
    expect(looselyParseAmount('3.4', 2)).toBe(3.4);
    expect(looselyParseAmount('3.45', 2)).toBe(3.45);
    // cant tell if this next case should be decimal or different format
    // so we set as full numbers
    expect(looselyParseAmount('3.456', 2)).toBe(3456); // the expected failing case
    expect(looselyParseAmount('3.4500', 2)).toBe(3.45);
    expect(looselyParseAmount('3.45000', 2)).toBe(3.45);
    expect(looselyParseAmount('3.450000', 2)).toBe(3.45);
    expect(looselyParseAmount('3.4500000', 2)).toBe(3.45);
    expect(looselyParseAmount('3.45000000', 2)).toBe(3.45);
    expect(looselyParseAmount('3.450000000', 2)).toBe(3.45);
  });

  test('looseParseAmount works with alternate formats', () => {
    expect(looselyParseAmount('3,45', 2)).toBe(3.45);
    expect(looselyParseAmount('3,456', 2)).toBe(3456); //expected failing case
    expect(looselyParseAmount('3,4500', 2)).toBe(3.45);
    expect(looselyParseAmount('3,45000', 2)).toBe(3.45);
    expect(looselyParseAmount('3,450000', 2)).toBe(3.45);
    expect(looselyParseAmount('3,4500000', 2)).toBe(3.45);
    expect(looselyParseAmount('3,45000000', 2)).toBe(3.45);
    expect(looselyParseAmount('3,450000000', 2)).toBe(3.45);
    expect(looselyParseAmount("3'456.78", 2)).toBe(3456.78);
    expect(looselyParseAmount("3'456.78000", 2)).toBe(3456.78);
    expect(looselyParseAmount('1,00,000.99', 2)).toBe(100000.99);
    expect(looselyParseAmount('1,00,000.99000', 2)).toBe(100000.99);
  });

  test('looseParseAmount works with leading decimal characters', () => {
    expect(looselyParseAmount('.45', 2)).toBe(0.45);
    expect(looselyParseAmount(',45', 2)).toBe(0.45);
  });
  ...
  test('looseParseAmount ignores non-numeric characters', () => {
    ...
    expect(looselyParseAmount('3_45_23.10', 2)).toBe(34523.1);
    expect(looselyParseAmount('(1 500.99)', 2)).toBe(-1500.99);
  });
