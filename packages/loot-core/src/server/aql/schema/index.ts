...
export const schema = {
  transactions: {
    ...
    native_amount: f('integer'),
    native_currency: f('string'),
    base_currency: f('string'),
    exchange_rate: f('string'),
    exchange_rate_date: f('string'),
    exchange_rate_id: f('id', { ref: 'exchange_rates' }),
    exchange_rate_locked: f('boolean', { default: true }),
    fx_recalculated_at: f('string'),
  ...
  exchange_rates: {
    ...
    rate: f('string', { required: true }),
    source: f('string', { default: 'manual' }),
    tombstone: f('boolean'),
  },
  categories: {
    id: f('id'),
    ...
    transactions: {
      ...
      v_transactions_internal: internalFields => {
        ...
        const fields = internalFields({
          ...
          native_amount: `IFNULL(_.native_amount, _.amount)`,
          exchange_rate_locked: `IFNULL(_.exchange_rate_locked, 1)`,
