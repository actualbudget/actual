...
let app = createApp<CategoryHandlers>();

app.method('category-create', mutator(async function ({
    name,
    groupId,
    isIncome,
    hidden,
  ...
  app.method('category-update', mutator(async function (category) {
    return withUndo(async () => {
      try {
  ...
  app.method('category-move', mutator(async function ({ id, groupId, targetId }) {
    return withUndo(async () => {
  ...
  app.method('category-delete', mutator(async function ({ id, transferId }) {
    return withUndo(async () => {
      let result = {};
      await batchMessages(async () => {
  ...
  app.method('category-group-update', mutator(async function (group) {
    return withUndo(async () => {
      return db.updateCategoryGroup(group);
    });
  }));
  
  app.method('category-group-move', mutator(async function ({ id, targetId }) {
    return withUndo(async () => {
      await batchMessages(async () => {
  ...
  app.method('category-group-delete', mutator(async function ({
    id,
    transferId,
  }) {
    return withUndo(async () => {
