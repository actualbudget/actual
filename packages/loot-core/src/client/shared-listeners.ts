...
export function listenForSyncEvent(actions, store) {
  ...
  listen('sync-event', info => {
    ...
    if (type === 'success') {
      ...
      let notif = null;
      let learnMore =
        '[Learn more](https://docs.actualbudget.org/Getting-Started/sync#debugging-sync-issues)';
        ...
        case 'file-old-version':
          ...
          notif = {
            ...
            message:
              ...
              '[Learn more about what this means](https://docs.actualbudget.org/Getting-Started/sync#what-does-resetting-sync-mean).' +
