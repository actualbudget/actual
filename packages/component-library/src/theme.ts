export const theme = {
  ...
  notePeopleBackground: 'var(--color-notePeopleBackground)',
  notePeopleBackgroundHover: 'var(--color-notePeopleBackgroundHover)',
  notePeopleDefault: 'var(--color-notePeopleDefault)',
  notePeopleText: 'var(--color-notePeopleText)',
