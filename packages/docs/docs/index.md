...
If you'd like to contribute to Actual Budget's documentation, start by reading the documentation standard, local setup, and guidelines on using images and screenshots located [in the contributing guides](/docs/contributing/writing-docs) and [in the documentation's github readme file](https://github.com/actualbudget/actual/tree/master/packages/docs#actual-budget-community-documentation). We use Docusaurus to build our website. You can click on _Edit this page_ at the bottom left of every page to open that page's Markdown document.
