...
- Actual also has a few other functions we will look at, like [scheduling transactions](./schedules), managing [payees](./payees) and adding and editing [rules](./rules), which will help you automate when entering or importing transactions.
