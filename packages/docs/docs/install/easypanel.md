...
[Easypanel](https://easypanel.io/) is a server control panel that can deploy Actual with one click using its official template, without needing to manually run Docker commands.
