...
Next, you'll need to connect to your running server version of Actual to access your budget files. You can authenticate using either a password or an [API token](./api-tokens.md) (recommended for scripts). API tokens can be created in [Settings](../settings/index.md#api-tokens).
