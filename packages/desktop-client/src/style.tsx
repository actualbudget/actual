...
const colorsDark = {
  ...
  noticeBackground: colorPallet.green100,
  noticeText: colorPallet.green500,
  noticeAccent: colorPallet.green300,
  warningBackground: colorPallet.orange100,
  warningText: colorPallet.orange600,
  warningAccent: colorPallet.orange300,
  errorBackground: colorPallet.red100,
  errorText: colorPallet.red500,
  errorAccent: colorPallet.red300,
