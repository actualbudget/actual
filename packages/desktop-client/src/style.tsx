...
export const colorsm = {
  ...
  tooltipItemBackgroundHover: colorPallet.gray300,
  tooltipItemBackgroundSelected: colorPallet.purple600,
  tooltipItemText: colorPallet.gray800,
  tooltipBorder: colorPallet.gray300,
  menuBackground: colorPallet.gray100,
  menuItemBackground: colorPallet.gray150,
  ...
  buttonNeutralBorder: colorPallet.gray50,
  buttonDisabledText: colorPallet.gray300,
  buttonDisabledBackground: colorPallet.gray150,
