...
export function AccountGroupSettings() {
  const [accountGroupNested = false, setAccountGroupNested] = useLocalPref(
    'ui.accountGroupNested',
  );

  const [accountGroupDisplayName = false, setAccountGroupDisplayName] =
    useLocalPref('ui.accountGroupDisplayName');
        ...
        <>
          ...
          <Text style={{ display: 'flex' }}>
            <Checkbox
              ...
              onChange={e =>
                setAccountGroupDisplayName(e.currentTarget.checked)
              }
            />
