...
function FileSettings({ savePrefs, prefs, pushModal, resetSync, closeBudgetAndImport }) {
  ...
  return (
    <>
      ...
      <ButtonSetting button={<Button onClick={closeBudgetAndImport}>Close budget and import data</Button>}>
        <Text>
          <strong>Importing</strong> creates a new budget file and must be done
          after you close the current one. Once closed, you can import a file to
          a new budget.
        </Text>
      </ButtonSetting>
