  ...
  useLayoutEffect(() => {
    if (containerRef.current) {
      ...
      for (const textNode of textNodes) {
        ...
        // Keep: letters, numbers, spaces, and common number formatting characters (.,-)
        // Replace: currency symbols and other special characters
        const redacted = original.replace(/[^a-zA-Z0-9\s.,\-+]/g, ' ');
