...
type ActionableListBoxItemProps<T> = {
  actions?: ReactNode;
  actionsBackgroundColor?: string;
  actionsWidth?: number;
  children?: ReactNode;
} & Omit<WithRequired<ListBoxItemProps<T>, 'value'>, 'children'>;

export function ActionableListBoxItem<T extends object>({
  value,
  textValue,
  actions,
