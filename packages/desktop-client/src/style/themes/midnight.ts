...
export const pageBackground = colorPalette.gray800;
...
export const pageTextLight = colorPalette.gray300;
...
export const pageTextLinkLight = colorPalette.purple400;
...
export const tableBackground = colorPalette.gray900;
...
export const tableHeaderBackground = colorPalette.gray800;
...
export const tableRowHeaderBackground = colorPalette.gray800;
...
export const sidebarItemAccnetSelected = colorPalette.purple400;
...
export const menuAutoCompleteBackgroundHover = colorPalette.gray600;
export const menuAutoCompleteText = colorPalette.gray200;
export const menuAutoCompleteTextHeader = colorPalette.purple400;
...
export const mobileHeaderText = colorPalette.purple400;
...
export const mobileNavBackground = colorPalette.gray800;
...
export const mobileModalBackground = colorPalette.gray800;
...
export const buttonNormalBackground = colorPalette.gray700;
export const buttonNormalBackgroundHover = colorPalette.gray500;
...
export const pillTextHighlighted = colorPalette.purple400;
