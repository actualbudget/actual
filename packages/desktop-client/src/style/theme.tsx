...
import * as darkTheme from '@desktop-client/style/themes/dark';
import * as developmentTheme from '@desktop-client/style/themes/development';
import * as lightTheme from '@desktop-client/style/themes/light';
import * as midnightTheme from '@desktop-client/style/themes/midnight';
