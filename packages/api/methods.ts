...
export function getSchedule(scheduleId: ScheduleEntity['id']) {
  return send('api/schedule-get', scheduleId);
}
...
export function deleteSchedule(scheduleId: ScheduleEntity['id']) {
