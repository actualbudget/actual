import { attachPluginMiddleware, BankSyncErrorCode, getSecret, saveSecret, } from '@actual-app/plugins-core-sync-server';
...
app.post('/accounts', async (req, res) => {
    try {
        ...
        else if ((pluggyCode && typeof pluggyCode === 'number' && pluggyCode >= 500) ||
